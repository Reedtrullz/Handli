...
export const workerJobResults = pgTable(
  ...
  (table) => [
    ...
    check(
      ...
      sql`${table.jobKind} in ('catalog-refresh', 'benchmark-price-refresh', 'store-catalog-price-refresh', 'physical-store-sync', 'historical-observation-collection', 'open-prices-benchmark-refresh', 'official-offer-discovery', 'official-offer-fetch', 'official-offer-ingestion', 'official-offer-lifecycle-reconcile')`,
    ),
    check(
