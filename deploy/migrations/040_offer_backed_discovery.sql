...
-- catalog source currently covers their GTIN. This is a static copy of the
-- reviewed-offer eligibility predicate from public_official_offer_rows_v1
-- (migrations 022 + 039), fanned out across every active product instead of an
-- explicit product-ID list. Keep the two definitions in sync deliberately.

create or replace function public.public_offer_backed_discovery_rows_v1(
