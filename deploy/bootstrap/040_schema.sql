-- Deterministic Handleplan bootstrap 040 artifact.
-- Generated from the exact pinned disposable schema through 038, corrected 039 semantics, and immutable 040 semantics.
-- Runner-owned migration/baseline metadata and runtime-role grants are intentionally excluded.
-- Migration-clock seed columns use transaction_timestamp() so the installer clock remains authoritative.
--
...
CREATE TABLE public.alert_events (
    ...
    CONSTRAINT alert_events_severity CHECK (((severity)::text = ANY ((ARRAY['info'::character varying, 'warning'::character varying, 'critical'::character varying])::text[]))),
    CONSTRAINT alert_events_status CHECK (((status)::text = ANY ((ARRAY['open'::character varying, 'acknowledged'::character varying, 'closed'::character varying])::text[]))),
...
CREATE TABLE public.approved_offers (
    ...
    CONSTRAINT approved_offers_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
    CONSTRAINT approved_offers_membership_requirement CHECK (((membership_requirement)::text = ANY ((ARRAY['public'::character varying, 'member'::character varying])::text[]))),
    ...
    CONSTRAINT approved_offers_status CHECK (((status)::text = ANY ((ARRAY['approved'::character varying, 'published'::character varying, 'expired'::character varying, 'revoked'::character varying])::text[]))),
...
CREATE TABLE public.canonical_products (
    ...
    CONSTRAINT canonical_products_package_unit CHECK (((package_unit IS NULL) OR ((package_unit)::text = ANY ((ARRAY['g'::character varying, 'ml'::character varying, 'piece'::character varying, 'package'::character varying])::text[])))),
    CONSTRAINT canonical_products_public_state_clock CHECK ((public_state_changed_at >= created_at)),
    CONSTRAINT canonical_products_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'quarantined'::character varying, 'retired'::character varying])::text[]))),
...
END)),
    ...
    CONSTRAINT catalog_observations_package_unit CHECK (((package_unit IS NULL) OR ((package_unit)::text = ANY ((ARRAY['g'::character varying, 'ml'::character varying, 'piece'::character varying, 'package'::character varying])::text[])))),
...
CREATE TABLE public.data_sources (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    public_state_changed_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT data_sources_kind CHECK (((source_kind)::text = ANY ((ARRAY['catalog'::character varying, 'ordinary_price'::character varying, 'offer'::character varying, 'store'::character varying, 'geocoder'::character varying, 'routing'::character varying, 'legacy'::character varying])::text[]))),
    ...
    CONSTRAINT data_sources_runtime_state CHECK (((runtime_state)::text = ANY ((ARRAY['approved'::character varying, 'conditional'::character varying, 'blocked'::character varying, 'revoked'::character varying])::text[])))
);
...
CREATE TABLE public.extracted_offer_candidates (
    ...
    CONSTRAINT extracted_offer_candidates_status CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'approved'::character varying, 'rejected'::character varying, 'superseded'::character varying])::text[])))
);
...
CREATE TABLE public.extraction_runs (
    ...
    CONSTRAINT extraction_runs_empty_result_allowed CHECK (((empty_result IS NULL) OR ((empty_result)::text = ANY ((ARRAY['not-empty'::character varying, 'confirmed-empty'::character varying, 'unexpected-empty'::character varying])::text[])))),
    CONSTRAINT extraction_runs_method_allowed CHECK (((extraction_method IS NULL) OR ((extraction_method)::text = ANY ((ARRAY['structured'::character varying, 'embedded-text'::character varying, 'ocr'::character varying])::text[])))),
...
END)),
    ...
    CONSTRAINT extraction_runs_status CHECK (((status)::text = ANY ((ARRAY['running'::character varying, 'completed'::character varying, 'degraded'::character varying, 'failed'::character varying])::text[]))),
...
CREATE TABLE public.geographic_postal_directory_regions (
    ...
    CONSTRAINT geographic_postal_directory_region_state CHECK (((coverage_state)::text = ANY ((ARRAY['complete'::character varying, 'ambiguous'::character varying])::text[])))
);
...
CREATE TABLE public.geographic_postal_directory_versions (
    ...
    CONSTRAINT geographic_postal_directory_seal_state CHECK (((((status)::text = 'building'::text) AND (sealed_at IS NULL)) OR (((status)::text = ANY ((ARRAY['approved'::character varying, 'blocked'::character varying, 'retired'::character varying])::text[])) AND (sealed_at IS NOT NULL)))),
    CONSTRAINT geographic_postal_directory_status CHECK (((status)::text = ANY ((ARRAY['building'::character varying, 'approved'::character varying, 'blocked'::character varying, 'retired'::character varying])::text[]))),
...
CREATE TABLE public.geographic_scopes (
    ...
    CONSTRAINT geographic_scopes_kind CHECK (((scope_kind)::text = ANY ((ARRAY['national'::character varying, 'region'::character varying, 'postal_set'::character varying, 'store_set'::character varying])::text[]))),
    CONSTRAINT geographic_scopes_public_state_clock CHECK ((public_state_changed_at >= created_at)),
    CONSTRAINT geographic_scopes_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'retired'::character varying])::text[])))
);
...
CREATE TABLE public.historical_price_statistics (
    ...
    CONSTRAINT historical_price_statistics_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
...
CREATE TABLE public.ingestion_runs (
    ...
    CONSTRAINT ingestion_runs_status CHECK (((status)::text = ANY ((ARRAY['running'::character varying, 'completed'::character varying, 'degraded'::character varying, 'failed'::character varying, 'cancelled'::character varying])::text[]))),
...
CREATE TABLE public.price_observations (
    ...
    CONSTRAINT price_observations_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
    CONSTRAINT price_observations_claim_eligibility CHECK (((claim_eligibility)::text = ANY ((ARRAY['ordinary_only'::character varying, 'historical_eligible'::character varying])::text[]))),
    CONSTRAINT price_observations_confidence_range CHECK (((confidence >= 0) AND (confidence <= 100))),
    CONSTRAINT price_observations_evidence_level CHECK (((evidence_level)::text = ANY ((ARRAY['chain'::character varying, 'branch'::character varying])::text[]))),
...
CREATE TABLE public.offer_conditions (
    ...
    CONSTRAINT offer_conditions_type CHECK (((condition_type)::text = ANY ((ARRAY['membership'::character varying, 'quantity'::character varying, 'channel'::character varying, 'payment'::character varying, 'other'::character varying])::text[])))
);
...
CREATE TABLE public.offer_targets (
    ...
    CONSTRAINT offer_targets_match_method CHECK (((match_method)::text = ANY ((ARRAY['exact_identifier'::character varying, 'deterministic_rule'::character varying, 'human_review'::character varying])::text[])))
);
...
CREATE TABLE public.official_offer_lifecycle_job_results (
    ...
    CONSTRAINT official_offer_lifecycle_job_results_publication CHECK (((publication_authorized AND publication_requested AND ((publication_state)::text = ANY ((ARRAY['source-ineligible'::character varying, 'evaluated'::character varying])::text[]))) OR ((NOT publication_authorized) AND ((publication_state)::text = 'foundation-disabled'::text)))),
    CONSTRAINT official_offer_lifecycle_job_results_state CHECK (((publication_state)::text = ANY ((ARRAY['foundation-disabled'::character varying, 'source-ineligible'::character varying, 'evaluated'::character varying])::text[]))),
...
CREATE TABLE public.physical_store_observations (
    ...
    CONSTRAINT physical_store_observations_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
    ...
    CONSTRAINT physical_store_observations_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'closed'::character varying, 'unknown'::character varying])::text[])))
);
...
CREATE TABLE public.physical_store_coverage_checks (
    ...
    CONSTRAINT physical_store_coverage_checks_reason_state CHECK (((((state)::text = 'complete'::text) AND (reason IS NULL) AND (record_count > 0)) OR (((state)::text = 'unknown'::text) AND ((reason)::text = ANY ((ARRAY['DUPLICATE_IDENTITY'::character varying, 'INVALID_RECORDS'::character varying, 'MISSING_SUPPORTED_CHAIN'::character varying, 'POSSIBLY_TRUNCATED'::character varying, 'REQUEST_FAILED'::character varying])::text[]))))),
    CONSTRAINT physical_store_coverage_checks_record_count_range CHECK (((record_count >= 0) AND (record_count <= 1000))),
    CONSTRAINT physical_store_coverage_checks_state CHECK (((state)::text = ANY ((ARRAY['complete'::character varying, 'unknown'::character varying])::text[])))
);
...
CREATE TABLE public.physical_stores (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT physical_stores_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
    ...
    CONSTRAINT physical_stores_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'closed'::character varying, 'unknown'::character varying])::text[])))
);
...
CREATE TABLE public.price_cache (
    ...
    CONSTRAINT price_cache_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
...
CREATE TABLE public.price_coverage_checks (
    ...
    checked_at timestamp with time zone NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT price_coverage_checks_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
    CONSTRAINT price_coverage_checks_state CHECK (((state)::text = ANY ((ARRAY['priced'::character varying, 'known_not_carried'::character varying, 'stale'::character varying, 'ineligible'::character varying, 'unknown'::character varying])::text[])))
);
...
CREATE TABLE public.private_review_evidence_renders (
    ...
    CONSTRAINT private_review_evidence_renders_image_mime CHECK (((mime_type)::text = ANY ((ARRAY['image/jpeg'::character varying, 'image/png'::character varying, 'image/webp'::character varying])::text[]))),
    ...
    CONSTRAINT private_review_evidence_renders_rights CHECK (((rights_classification)::text = ANY ((ARRAY['private_review'::character varying, 'public_display'::character varying])::text[]))),
...
CREATE TABLE public.product_families (
    ...
    status character varying(16) DEFAULT 'active'::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT product_families_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'retired'::character varying])::text[])))
);
...
CREATE TABLE public.product_family_memberships (
    ...
    CONSTRAINT product_family_memberships_method CHECK (((method)::text = ANY ((ARRAY['exact_identifier'::character varying, 'deterministic_rule'::character varying, 'human_review'::character varying])::text[]))),
    CONSTRAINT product_family_memberships_review_state CHECK (((review_state)::text = ANY ((ARRAY['approved'::character varying, 'candidate'::character varying, 'rejected'::character varying])::text[])))
);
...
CREATE TABLE public.product_identifiers (
    ...
    CONSTRAINT product_identifiers_scheme CHECK (((scheme)::text = ANY ((ARRAY['ean8'::character varying, 'ean13'::character varying, 'source'::character varying])::text[]))),
    CONSTRAINT product_identifiers_source_scope CHECK (((((scheme)::text = ANY ((ARRAY['ean8'::character varying, 'ean13'::character varying])::text[])) AND (source_id IS NULL)) OR (((scheme)::text = 'source'::text) AND (source_id IS NOT NULL))))
);
...
CREATE TABLE public.public_api_request_budget_events (
    ...
    claimed_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    CONSTRAINT public_api_request_budget_events_route_key_allowed CHECK (((route_key)::text = ANY ((ARRAY['discovery-impact'::character varying, 'discovery-search'::character varying, 'locations-current'::character varying, 'locations-search'::character varying, 'plan-candidates'::character varying, 'plans'::character varying, 'plans-travel'::character varying, 'products-search'::character varying, 'source-status'::character varying])::text[])))
);
...
END)),
    ...
    CONSTRAINT publication_captures_rights_classification CHECK (((rights_classification)::text = ANY ((ARRAY['private_review'::character varying, 'extract_only'::character varying, 'public_display'::character varying])::text[])))
);
...
CREATE TABLE public.publications (
    ...
    CONSTRAINT publications_chain_supported CHECK (((chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[]))),
    CONSTRAINT publications_content_kind_allowed CHECK (((content_kind IS NULL) OR ((content_kind)::text = ANY ((ARRAY['structured-feed'::character varying, 'publication'::character varying])::text[])))),
    ...
    CONSTRAINT publications_status CHECK (((status)::text = ANY ((ARRAY['discovered'::character varying, 'captured'::character varying, 'published'::character varying, 'expired'::character varying, 'failed'::character varying])::text[]))),
...
CREATE TABLE public.review_actions (
    ...
    CONSTRAINT review_actions_action CHECK (((action)::text = ANY ((ARRAY['approve'::character varying, 'correct_and_approve'::character varying, 'reject'::character varying, 'revoke'::character varying])::text[]))),
...
CREATE TABLE public.reviewed_family_definitions (
    ...
    CONSTRAINT reviewed_family_definitions_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'retired'::character varying])::text[])))
);
...
CREATE TABLE public.reviewed_family_membership_decisions (
    ...
    CONSTRAINT reviewed_family_membership_decisions_decision CHECK (((decision)::text = ANY ((ARRAY['approved'::character varying, 'candidate'::character varying, 'rejected'::character varying])::text[]))),
    CONSTRAINT reviewed_family_membership_decisions_method CHECK (((method)::text = ANY ((ARRAY['deterministic_rule'::character varying, 'human_review'::character varying])::text[]))),
...
CREATE TABLE public.source_health_snapshots (
    ...
    CONSTRAINT source_health_snapshots_status CHECK (((status)::text = ANY ((ARRAY['healthy'::character varying, 'degraded'::character varying, 'failed'::character varying, 'disabled'::character varying])::text[]))),
...
CREATE TABLE public.source_permissions (
    ...
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT source_permissions_decision CHECK (((decision)::text = ANY ((ARRAY['approved'::character varying, 'conditional'::character varying, 'blocked'::character varying, 'revoked'::character varying])::text[]))),
...
CREATE TABLE public.source_products (
    ...
    CONSTRAINT source_products_match_state CHECK (((match_state)::text = ANY ((ARRAY['unmatched'::character varying, 'candidate'::character varying, 'matched'::character varying, 'quarantined'::character varying])::text[]))),
...
CREATE TABLE public.source_record_outcomes (
    ...
    recorded_at timestamp with time zone NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT source_record_outcomes_chain_supported CHECK (((subject_chain IS NULL) OR ((subject_chain)::text = ANY ((ARRAY['bunnpris'::character varying, 'extra'::character varying, 'rema-1000'::character varying, 'fudi'::character varying, 'holdbart'::character varying, 'meny'::character varying, 'havaristen'::character varying, 'joker'::character varying, 'spar'::character varying, 'fastcandy'::character varying, 'europris'::character varying, 'engrossnett'::character varying, 'oda'::character varying])::text[])))),
    ...
    CONSTRAINT source_record_outcomes_reason_state CHECK (((((outcome_state)::text = 'accepted'::text) AND (reason IS NULL)) OR (((outcome_state)::text = ANY ((ARRAY['quarantined'::character varying, 'unknown'::character varying])::text[])) AND (reason IS NOT NULL)))),
    CONSTRAINT source_record_outcomes_state CHECK (((outcome_state)::text = ANY ((ARRAY['accepted'::character varying, 'quarantined'::character varying, 'unknown'::character varying])::text[])))
);
...
CREATE TABLE public.worker_job_results (
    ...
    CONSTRAINT worker_job_results_job_kind CHECK (((job_kind)::text = ANY ((ARRAY['catalog-refresh'::character varying, 'benchmark-price-refresh'::character varying, 'physical-store-sync'::character varying, 'historical-observation-collection'::character varying, 'open-prices-benchmark-refresh'::character varying, 'official-offer-discovery'::character varying, 'official-offer-fetch'::character varying, 'official-offer-ingestion'::character varying, 'official-offer-lifecycle-reconcile'::character varying])::text[]))),
    ...
    CONSTRAINT worker_job_results_status CHECK (((status)::text = ANY ((ARRAY['succeeded'::character varying, 'partial'::character varying, 'cancelled'::character varying, 'timed-out'::character varying, 'failed'::character varying])::text[]))),
...
--
-- Data for Name: approved_offers; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: canonical_products; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: catalog_observations; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.data_sources (id, display_name, source_kind, runtime_state, public_reference_url, permission_reviewed_at, permission_expires_at, kill_switch_reason, created_at, updated_at, public_state_changed_at) VALUES ('legacy-import', 'Legacy price_cache import', 'legacy', 'blocked', NULL, NULL, NULL, 'Legacy rows lack sufficient provenance for official or historical claims', pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp());
INSERT INTO public.data_sources (id, display_name, source_kind, runtime_state, public_reference_url, permission_reviewed_at, permission_expires_at, kill_switch_reason, created_at, updated_at, public_state_changed_at) VALUES ('kassalapp', 'Kassalapp', 'ordinary_price', 'approved', 'https://kassal.app/api/docs', pg_catalog.transaction_timestamp(), NULL, NULL, pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp());
INSERT INTO public.data_sources (id, display_name, source_kind, runtime_state, public_reference_url, permission_reviewed_at, permission_expires_at, kill_switch_reason, created_at, updated_at, public_state_changed_at) VALUES ('open-prices', 'Open Prices (crowdsourced)', 'ordinary_price', 'approved', 'https://prices.openfoodfacts.org', pg_catalog.transaction_timestamp(), NULL, NULL, pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp());
INSERT INTO public.data_sources (id, display_name, source_kind, runtime_state, public_reference_url, permission_reviewed_at, permission_expires_at, kill_switch_reason, created_at, updated_at, public_state_changed_at) VALUES ('tjek', 'Tjek / Bunnpris kundeavis', 'offer', 'approved', NULL, pg_catalog.transaction_timestamp(), NULL, NULL, pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp());


--
-- Data for Name: extracted_offer_candidates; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: family_taxonomy_versions; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.family_taxonomy_versions (version_id, taxonomy_id, taxonomy_version, contract_version, published_at, content_sha256, content_json, expected_family_count, expected_alias_count, created_at) VALUES ('handleplan-reviewed-families@1.0.0', 'handleplan-reviewed-families', '1.0.0', 1, '2026-07-16 00:00:00+00', '1d917ee4268615ad510a622ea30d69977191cffc143313a7dbecbad37debf520', '[{"id": "family:brod", "slug": "brod", "status": "active", "aliases": ["brød"], "labelNo": "Brød"}, {"id": "family:kaffe", "slug": "kaffe", "status": "active", "aliases": [], "labelNo": "Kaffe"}, {"id": "family:melk", "slug": "melk", "status": "active", "aliases": ["mjølk"], "labelNo": "Melk"}]', 3, 2, pg_catalog.transaction_timestamp());


--
-- Data for Name: geographic_postal_directory_codes; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: geographic_postal_directory_regions; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: geographic_postal_directory_versions; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: geographic_scope_postal_codes; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: geographic_scope_regions; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: geographic_scope_stores; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: geographic_scopes; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.geographic_scopes (id, scope_key, scope_kind, label, country_code, status, created_at, updated_at, public_state_changed_at) VALUES (1, 'no-national', 'national', 'Norge (nasjonalt)', 'NO', 'active', pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp());


--
-- Data for Name: historical_price_statistics; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.ingestion_runs (id, source_id, run_type, status, started_at, completed_at, counts, error_class, created_at, job_id, terminalized_at) VALUES (1, 'legacy-import', 'price_cache_backfill', 'completed', pg_catalog.transaction_timestamp(), pg_catalog.transaction_timestamp(), '{"rows": 0}', NULL, pg_catalog.transaction_timestamp(), NULL, pg_catalog.transaction_timestamp());
...
--
-- Data for Name: offer_targets; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: official_offer_lifecycle_job_results; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: official_offer_lifecycle_leases; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: official_offer_publication_health_facts; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: official_offer_publication_policy; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.official_offer_publication_policy (policy_key, enabled, policy_version, updated_at) VALUES ('official-offer-publication-v1', false, 1, pg_catalog.transaction_timestamp());


--
-- Data for Name: physical_store_coverage_checks; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: physical_store_observations; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: physical_stores; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: price_coverage_checks; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: private_review_evidence_consumptions; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: private_review_evidence_renders; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: product_family_memberships; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: provider_request_budget_events; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: public_api_request_budget_events; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: publication_captures; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: reviewed_family_aliases; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.reviewed_family_aliases (version_id, family_id, alias, created_at) VALUES ('handleplan-reviewed-families@1.0.0', 'family:brod', 'brød', pg_catalog.transaction_timestamp());
INSERT INTO public.reviewed_family_aliases (version_id, family_id, alias, created_at) VALUES ('handleplan-reviewed-families@1.0.0', 'family:melk', 'mjølk', pg_catalog.transaction_timestamp());


--
-- Data for Name: reviewed_family_definitions; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.reviewed_family_definitions (version_id, family_id, slug, label_no, parent_family_id, status, created_at) VALUES ('handleplan-reviewed-families@1.0.0', 'family:brod', 'brod', 'Brød', NULL, 'active', pg_catalog.transaction_timestamp());
INSERT INTO public.reviewed_family_definitions (version_id, family_id, slug, label_no, parent_family_id, status, created_at) VALUES ('handleplan-reviewed-families@1.0.0', 'family:kaffe', 'kaffe', 'Kaffe', NULL, 'active', pg_catalog.transaction_timestamp());
INSERT INTO public.reviewed_family_definitions (version_id, family_id, slug, label_no, parent_family_id, status, created_at) VALUES ('handleplan-reviewed-families@1.0.0', 'family:melk', 'melk', 'Melk', NULL, 'active', pg_catalog.transaction_timestamp());


--
-- Data for Name: reviewed_family_membership_decisions; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: source_health_snapshots; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: source_permissions; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.source_permissions (id, source_id, decision, reviewed_at, valid_until, public_reference_url, private_reference_key, permissions, notes, created_at) VALUES (1, 'kassalapp', 'approved', pg_catalog.transaction_timestamp(), NULL, 'https://kassal.app/api/docs', NULL, '{"catalog": true, "priceHistory": true, "ordinaryPrice": true, "physicalStore": true}', 'Reviewed owner approval for the v1 public launch; all four ingestion scopes', pg_catalog.transaction_timestamp());
INSERT INTO public.source_permissions (id, source_id, decision, reviewed_at, valid_until, public_reference_url, private_reference_key, permissions, notes, created_at) VALUES (2, 'open-prices', 'approved', pg_catalog.transaction_timestamp(), NULL, 'https://prices.openfoodfacts.org/api/docs', NULL, '{"ordinaryPrice": true}', 'Reviewed owner approval for Open Prices as a gap-filling ordinary-price source for Norwegian chains (Bunnpris, Extra, REMA 1000). ODbL attribution required.', pg_catalog.transaction_timestamp());
INSERT INTO public.source_permissions (id, source_id, decision, reviewed_at, valid_until, public_reference_url, private_reference_key, permissions, notes, created_at) VALUES (3, 'tjek', 'approved', pg_catalog.transaction_timestamp(), NULL, NULL, NULL, '{"catalog": true}', NULL, pg_catalog.transaction_timestamp());
INSERT INTO public.source_permissions (id, source_id, decision, reviewed_at, valid_until, public_reference_url, private_reference_key, permissions, notes, created_at) VALUES (4, 'tjek', 'approved', pg_catalog.clock_timestamp(), NULL, NULL, NULL, '{"officialOffers": true, "officialOfferCapabilities": ["capture", "discover", "extract"], "officialOfferRightsClassifications": ["public_display"]}', 'Supersedes id=3: adds official-offer capabilities for Tjek weekly catalog pipeline.', pg_catalog.transaction_timestamp());


--
-- Data for Name: source_products; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: source_record_outcomes; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: worker_job_results; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: worker_leases; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: approved_offers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.approved_offers_id_seq', 1, false);


--
-- Name: canonical_products_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.canonical_products_id_seq', 1, false);


--
-- Name: catalog_observations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.catalog_observations_id_seq', 1, false);


--
-- Name: extracted_offer_candidates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.extracted_offer_candidates_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.extraction_runs_id_seq', 1, false);


--
-- Name: geographic_scopes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.geographic_scopes_id_seq', 1, true);


--
-- Name: ingestion_runs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.ingestion_runs_id_seq', 1, true);


--
-- Name: offer_conditions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.offer_conditions_id_seq', 1, false);


--
-- Name: official_offer_publication_health_facts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.official_offer_publication_health_facts_id_seq', 1, false);


--
-- Name: physical_store_coverage_checks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.physical_store_coverage_checks_id_seq', 1, false);


--
-- Name: physical_store_observations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.physical_store_observations_id_seq', 1, false);


--
-- Name: physical_stores_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.physical_stores_id_seq', 1, false);


--
-- Name: price_coverage_checks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.price_coverage_checks_id_seq', 1, false);


--
-- Name: price_observations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.price_observations_id_seq', 1, false);


--
-- Name: private_review_evidence_consumptions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.private_review_evidence_consumptions_id_seq', 1, false);


--
-- Name: private_review_evidence_renders_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.private_review_evidence_renders_id_seq', 1, false);


--
-- Name: product_identifiers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.product_identifiers_id_seq', 1, false);


--
-- Name: publication_captures_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.publication_captures_id_seq', 1, false);
...
--
-- Name: review_actions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.review_actions_id_seq', 1, false);


--
-- Name: reviewed_family_membership_decisions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.reviewed_family_membership_decisions_id_seq', 1, false);


--
-- Name: source_health_snapshots_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.source_health_snapshots_id_seq', 1, false);


--
-- Name: source_permissions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.source_permissions_id_seq', 4, true);


--
-- Name: source_record_outcomes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.source_record_outcomes_id_seq', 1, false);


--
-- Name: worker_job_results_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.worker_job_results_id_seq', 1, false);
...
CREATE UNIQUE INDEX product_identifiers_gtin_value_unique ON public.product_identifiers USING btree (value) WHERE ((scheme)::text = ANY ((ARRAY['ean8'::character varying, 'ean13'::character varying])::text[]));
...
--
-- Name: FUNCTION append_operations_alert_evaluation_v1(p_evaluated_at timestamp with time zone, p_source_roster jsonb, p_assessments jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.append_operations_alert_evaluation_v1(p_evaluated_at timestamp with time zone, p_source_roster jsonb, p_assessments jsonb) FROM PUBLIC;


--
-- Name: FUNCTION assert_public_official_offer_payload_v1(p_payload_bytes bigint); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.assert_public_official_offer_payload_v1(p_payload_bytes bigint) FROM PUBLIC;


--
-- Name: FUNCTION canonical_official_offer_edition_identity(identity_source_id text, identity_external_id text, identity_chain text, identity_title text, identity_content_kind text, identity_geographic_scope_id bigint, identity_declared_scope jsonb, identity_valid_from timestamp with time zone, identity_valid_until timestamp with time zone, identity_discovered_at timestamp with time zone); Type: ACL; Schema: public; Owner: -
--



--
-- Name: FUNCTION canonical_official_offer_scope_identity(declared_scope jsonb); Type: ACL; Schema: public; Owner: -
--



--
-- Name: FUNCTION claim_public_api_request_budget(p_route_key text); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.claim_public_api_request_budget(p_route_key text) FROM PUBLIC;


--
-- Name: FUNCTION enforce_approved_offer_lifecycle_transition_v1(); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.enforce_approved_offer_lifecycle_transition_v1() FROM PUBLIC;


--
-- Name: FUNCTION enforce_official_offer_lifecycle_job_boundary_v1(); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.enforce_official_offer_lifecycle_job_boundary_v1() FROM PUBLIC;


--
-- Name: FUNCTION is_canonical_membership_program_id_v1(p_value text); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.is_canonical_membership_program_id_v1(p_value text) FROM PUBLIC;


--
-- Name: FUNCTION official_offer_lifecycle_is_revoked_v1(p_offer_id bigint, p_evaluated_at timestamp with time zone); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.official_offer_lifecycle_is_revoked_v1(p_offer_id bigint, p_evaluated_at timestamp with time zone) FROM PUBLIC;


--
-- Name: FUNCTION official_offer_lifecycle_reconcile_v1(p_source_id text, p_job_id text, p_run_id text, p_scheduled_at timestamp with time zone, p_owner_id text, p_batch_limit integer, p_publication_requested boolean); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.official_offer_lifecycle_reconcile_v1(p_source_id text, p_job_id text, p_run_id text, p_scheduled_at timestamp with time zone, p_owner_id text, p_batch_limit integer, p_publication_requested boolean) FROM PUBLIC;


--
-- Name: FUNCTION operations_alert_export_rows_v1(p_after_event_id bigint, p_result_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.operations_alert_export_rows_v1(p_after_event_id bigint, p_result_limit integer) FROM PUBLIC;


--
-- Name: FUNCTION operations_dashboard_rows_v1(p_source_ids text[], p_result_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.operations_dashboard_rows_v1(p_source_ids text[], p_result_limit integer) FROM PUBLIC;


--
-- Name: FUNCTION private_review_candidate_rows_v1(p_candidate_id bigint, p_evaluation_as_of timestamp with time zone, p_chain text, p_scope_kind text, p_min_confidence integer, p_max_confidence integer, p_min_age_hours integer, p_max_age_hours integer, p_anomaly text, p_cursor_created_at timestamp with time zone, p_cursor_id bigint, p_result_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.private_review_candidate_rows_v1(p_candidate_id bigint, p_evaluation_as_of timestamp with time zone, p_chain text, p_scope_kind text, p_min_confidence integer, p_max_confidence integer, p_min_age_hours integer, p_max_age_hours integer, p_anomaly text, p_cursor_created_at timestamp with time zone, p_cursor_id bigint, p_result_limit integer) FROM PUBLIC;


--
-- Name: FUNCTION private_review_decide_v1(p_candidate_id bigint, p_expected_version integer, p_action text, p_actor_id text, p_reason text, p_target_kind text, p_target_gtin text, p_target_family_slug text, p_pricing_kind text, p_offer_price_ore integer, p_before_price_ore integer, p_multibuy_quantity integer, p_multibuy_total_ore integer, p_eligibility_kind text, p_membership_program_id text, p_valid_from timestamp with time zone, p_valid_until timestamp with time zone, p_channels text[]); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.private_review_decide_v1(p_candidate_id bigint, p_expected_version integer, p_action text, p_actor_id text, p_reason text, p_target_kind text, p_target_gtin text, p_target_family_slug text, p_pricing_kind text, p_offer_price_ore integer, p_before_price_ore integer, p_multibuy_quantity integer, p_multibuy_total_ore integer, p_eligibility_kind text, p_membership_program_id text, p_valid_from timestamp with time zone, p_valid_until timestamp with time zone, p_channels text[]) FROM PUBLIC;


--
-- Name: FUNCTION private_review_decide_v2(p_candidate_id bigint, p_expected_version integer, p_action text, p_actor_id text, p_reviewer_session_id text, p_evidence_proof_sha256 text, p_reason text, p_target_kind text, p_target_gtin text, p_target_family_slug text, p_pricing_kind text, p_offer_price_ore integer, p_before_price_ore integer, p_multibuy_quantity integer, p_multibuy_total_ore integer, p_eligibility_kind text, p_membership_program_id text, p_valid_from timestamp with time zone, p_valid_until timestamp with time zone, p_channels text[]); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.private_review_decide_v2(p_candidate_id bigint, p_expected_version integer, p_action text, p_actor_id text, p_reviewer_session_id text, p_evidence_proof_sha256 text, p_reason text, p_target_kind text, p_target_gtin text, p_target_family_slug text, p_pricing_kind text, p_offer_price_ore integer, p_before_price_ore integer, p_multibuy_quantity integer, p_multibuy_total_ore integer, p_eligibility_kind text, p_membership_program_id text, p_valid_from timestamp with time zone, p_valid_until timestamp with time zone, p_channels text[]) FROM PUBLIC;


--
-- Name: FUNCTION private_review_record_evidence_render_v1(p_candidate_id bigint, p_expected_version integer, p_capture_checksum text, p_crop_reference text, p_presentation text, p_rights_classification text, p_actor_id text, p_reviewer_session_id text, p_evidence_proof_sha256 text, p_expires_at timestamp with time zone); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.private_review_record_evidence_render_v1(p_candidate_id bigint, p_expected_version integer, p_capture_checksum text, p_crop_reference text, p_presentation text, p_rights_classification text, p_actor_id text, p_reviewer_session_id text, p_evidence_proof_sha256 text, p_expires_at timestamp with time zone) FROM PUBLIC;


--
-- Name: FUNCTION public_offer_backed_discovery_rows_v1(p_evaluation_as_of timestamp with time zone); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.public_offer_backed_discovery_rows_v1(p_evaluation_as_of timestamp with time zone) FROM PUBLIC;


--
-- Name: FUNCTION public_official_offer_rows_v1(p_product_ids bigint[], p_evaluation_as_of timestamp with time zone); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.public_official_offer_rows_v1(p_product_ids bigint[], p_evaluation_as_of timestamp with time zone) FROM PUBLIC;


--
-- Name: FUNCTION record_official_offer_publication_health_v1(); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.record_official_offer_publication_health_v1() FROM PUBLIC;


--
-- Name: FUNCTION stamp_operations_runtime_boundary_v1(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION stamp_private_review_action_decision_clock(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE approved_offers; Type: ACL; Schema: public; Owner: -
--



--
-- Name: SEQUENCE approved_offers_id_seq; Type: ACL; Schema: public; Owner: -
--



--
-- Name: TABLE extracted_offer_candidates; Type: ACL; Schema: public; Owner: -
--



--
-- Name: SEQUENCE extracted_offer_candidates_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE offer_conditions; Type: ACL; Schema: public; Owner: -
--



--
-- Name: SEQUENCE offer_conditions_id_seq; Type: ACL; Schema: public; Owner: -
--



--
-- Name: TABLE offer_targets; Type: ACL; Schema: public; Owner: -
--



--
-- Name: TABLE publication_captures; Type: ACL; Schema: public; Owner: -
--



--
-- Name: SEQUENCE publication_captures_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE publications_id_seq; Type: ACL; Schema: public; Owner: -
--



--
-- Name: TABLE review_actions; Type: ACL; Schema: public; Owner: -
--



--
-- Name: SEQUENCE review_actions_id_seq; Type: ACL; Schema: public; Owner: -
--
