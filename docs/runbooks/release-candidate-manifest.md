...
context, not retained candidate-current release proof. The preceding full
implementation and V1-17 drafts are preserved as historical, immutable
milestones. None of the drafts is a release or a claim about production.
