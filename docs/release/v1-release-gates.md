...
**Last assessed:** 2026-09-22 (candidate re-assessment on branch `codex/prices-and-discounts`; the 2026-07-18 assessment below remains a historical record of baseline `29fb91a6ae3e7a9ed79243f6b70007a0d0ce434c` and is not converted into current evidence)
...
| G4 Planner correctness | partial | Complete-basket planner/domain suites, a separately implemented offer-aware V2 oracle with exact membership-program isolation, and the [cross-browser-remediated implementation verification](../evidence/v1/v1-source-neutral-cross-browser-remediation-2026-07-17/verification.md). 2026-09-22 re-check: `acceptance:v1-baskets:check` still exits 2 with 60 pending runs (retained baseline in [plan Task 17](../superpowers/plans/2026-09-08-handleplan-full-release.md)). | Every supported region must pass the real rights-cleared 60-run corpus and manual reconciliation. The current source-neutral corpus intentionally remains 0 passed and 60 pending. |
...
| G6 Travel privacy | partial | Opt-in ephemeral address/current-location tokens, self-hosted Valhalla boundary, storage/URL/cache sentinel checks, and the [cross-browser-remediated implementation verification](../evidence/v1/v1-source-neutral-cross-browser-remediation-2026-07-17/verification.md). 2026-09-22 re-check: travel unit/production-contract suites 17/17 ([travel-privacy.md](../evidence/release-readiness/travel-privacy.md)); live route/log proof still outstanding. | Accepted Kartverket URL/retention and edge/application log policy, live Valhalla route/log proof, infrastructure telemetry sentinel evidence, and device/browser review. |
| G7 Offline shopping | partial | Immutable IndexedDB trip snapshot, API-cache exclusion tests, and the [production-build three-engine application-origin-outage journeys](../evidence/v1/v1-source-neutral-cross-browser-remediation-2026-07-17/verification.md). 2026-09-22 re-check on sealed build `e82e322f…`: 45/45 three-engine browser journeys and 12/12 handlemodus matrix ([device-accessibility.md](../evidence/release-readiness/device-accessibility.md)) | Production PWA trip completed offline on iOS and Android physical devices, including install, reload, checklist progress, eviction/staleness behavior, and accessible touch use. Not performed; external device gate. |
| G8 Accessibility | partial | Phase 1 evidence, the [local V1-18 automated delta](../evidence/v1/v1-18-accessibility-automated-2026-07-17.md), and local Chromium/Firefox/WebKit reflow/axe journeys in the [cross-browser-remediated implementation verification](../evidence/v1/v1-source-neutral-cross-browser-remediation-2026-07-17/verification.md). 2026-09-22 re-check: automated WCAG/axe/resize/reflow suites pass on sealed build `e82e322f…` ([device-accessibility.md](../evidence/release-readiness/device-accessibility.md)) | Exact-candidate Chromium/Firefox/WebKit CI execution, native-zoom evidence, plus accepted VoiceOver, keyboard-only, and mobile-device reports. Not performed; external device/AT gate. |
| G9 Security, privacy, and legal | partial | Protected Cloudflare Access preview, server-only credential boundary, source registry, [Norwegian privacy notice](../privacy/personvern.md), [data-flow/threat model](../security/data-flow-threat-model.md), [security policy](../../SECURITY.md), code license/third-party boundary, tested response-header baseline, allowlist-only readiness telemetry with application sentinel tests, and [repository dependency/license/secret gates](../security/supply-chain.md). 2026-09-22 re-check: audit 0 high/critical with 2 moderate remaining, license policy 451 packages, secret scan 724 files, security script suite 10/0 ([security-governance.md](../evidence/release-readiness/security-governance.md)) | Accepted operator/data-controller and processor facts, legal/privacy/security review, actual edge/VPS/provider/monitoring logging and retention evidence, rights/marks/imagery review, distributed abuse controls, route-origin and all-boundary telemetry sentinel proof, container/history scans, and tested confidential privacy/security contacts. |
| G10 Operations | partial | The [cross-browser-remediated implementation verification](../evidence/v1/v1-source-neutral-cross-browser-remediation-2026-07-17/verification.md) covers forward migrations through 026, the read-only operations role, least-privilege private runtimes, image handoff, rollback, inert backup/restore tooling, and monitor contracts at its historical baseline. 2026-09-22 re-check on fresh PostgreSQL 16 container: migrations through 043 applied and the full db integration battery passed 436/436; backup 45/0, image 17/0, monitor 11/0 tooling suites ([operations.md](../evidence/release-readiness/operations.md), [refresh-observation.md](../evidence/release-readiness/refresh-observation.md)). These are local candidate checks, not VPS/CI proof. | Candidate-current Linux CI and VPS proof, encrypted off-host provider activation and authenticated manifest origin, provisioned backup grants/blob view, supervised clean-host restore with private blobs and RPO/RTO, a separately provisioned and composed production alert scheduler/delivery identity, signed OCI promotion, container scan, and live rollback drills. |
| G11 Real baskets | partial | [versioned benchmark baskets](../data/benchmark-baskets.v1.json), executable V2 protocol/oracle schemas, and 25/25 acceptance-foundation tests. 2026-09-22 re-check: corpus remains 0 passed / 60 pending pending SPAR/Joker/Europris source gates. | Every declared region passes the real rights-cleared 60-run corpus; at least five baskets per region are manually reconciled to source, conditions, validity, offers, membership program, and geography. |
