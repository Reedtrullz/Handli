...
\restrict MYagaOEagB0FWv1nHr9JBa1pY5Vzwlzp0oPTkKrBWMjYAZxwtW6ceo0shW85KsP
    ...
    where offer.status = 'published'
      ...
      and (
        (
          ...
          and review.new_values #> '{decision,pricing,offerPriceOre}'
            = pg_catalog.to_jsonb(offer.amount_ore)
          and ((offer.before_amount_ore is null and jsonb_typeof(review.new_values #> '{decision,pricing,beforePriceOre}') = 'null')
        ...
        (
          ...
          and review.new_values #> '{decision,pricing,totalOre}'
            = pg_catalog.to_jsonb(offer.multibuy_group_amount_ore)
          and ((offer.before_amount_ore is null and jsonb_typeof(review.new_values #> '{decision,pricing,beforeUnitPriceOre}') = 'null')
...
--
-- Name: COLUMN catalog_observations.category_path; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.catalog_observations.category_path IS 'Nullable source category evidence: NULL is unknown/not captured; [] is explicitly observed empty.';
...
--
-- Name: handleplan_schema_migrations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: handleplan_schema_migrations handleplan_schema_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.handleplan_schema_migrations
    ADD CONSTRAINT handleplan_schema_migrations_pkey PRIMARY KEY (id);
...
ALTER TABLE public.extracted_offer_candidates DISABLE TRIGGER extracted_offer_candidates_append_only;
...
ALTER TABLE public.extracted_offer_candidates DISABLE TRIGGER extracted_offer_candidates_creation_clock;
...
ALTER TABLE public.extraction_runs DISABLE TRIGGER extraction_runs_creation_clock;
...
ALTER TABLE public.extraction_runs DISABLE TRIGGER extraction_runs_trust_boundary;
...
ALTER TABLE public.publication_captures DISABLE TRIGGER publication_captures_append_only;
...
ALTER TABLE public.publication_captures DISABLE TRIGGER publication_captures_creation_clock;
...
ALTER TABLE public.publication_captures DISABLE TRIGGER publication_captures_permission_boundary;
...
ALTER TABLE public.publications DISABLE TRIGGER publications_creation_clock;
...
ALTER TABLE public.publications DISABLE TRIGGER publications_offer_identity_boundary;
...
ALTER TABLE public.review_actions DISABLE TRIGGER review_actions_append_only;
...
ALTER TABLE public.review_actions DISABLE TRIGGER review_actions_creation_clock;
...
ALTER TABLE public.review_actions DISABLE TRIGGER review_actions_z_decision_clock;
...
\unrestrict MYagaOEagB0FWv1nHr9JBa1pY5Vzwlzp0oPTkKrBWMjYAZxwtW6ceo0shW85KsP
