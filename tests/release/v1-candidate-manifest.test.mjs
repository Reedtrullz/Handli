...
const draftPath = resolve(
  repositoryRoot,
  "docs/evidence/v1/v1-source-neutral-typecheck-remediation-2026-07-17/release-candidate.v1.json",
);
...
test("the repository draft binds current files while remaining explicitly blocked", () => {
  ...
  assert.deepEqual(result, {
    candidateId: "v1-source-neutral-typecheck-remediation-2026-07-17",
